        ...
        <div class="row" v-if="showHeader">
            <div class="eight columns">
                <a href="/alma/#/about" @mouseover="subMenuVisible = true">
                    ...
                    <g class="alma-text"> 
                        <path d="M52.78,42.377c-1.216,0-2.245-0.843-2.622-1.967c-0.559-1.592-2.338-2.714-3.93-2.714
                        ...
                        <path d="M236.226,42.377c-1.219,0-2.246-0.843-2.622-1.967c-0.562-1.592-2.342-2.714-3.932-2.714
